...
const Navbar = () => {
    ...
    return(
        <div className="flex justify-between items-center h-24 max-w-[1240] mx-auto px-4 text-white z-40">
            ...
            <div className={!nav ? 'fixed z-40 left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-gray-700 ease-in-out duratio-500' : 'fixed left-[-100%]'}>
