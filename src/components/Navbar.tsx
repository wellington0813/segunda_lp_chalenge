...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-24 bg-zinc-800 flex justify-between items-center">
      <div className="flex w-full justify-between max-w-7xl mx-auto px-4 text-white">
        ...
        <div
          className={
            !nav
              ? "fixed z-[99] left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-gray-700 ease-in-out duratio-500"
              : "fixed left-[-100%]"
          }
        >
